...
import { useIsMobile } from "@/components/ui/sidebar-hooks"
    ...
    return (
        <button
            ...
            className={cn(
                ...
                "[[data-collapsible=offcanvas]_&]:hidden",
                "[[data-state=collapsed]_&]:cursor-pointer [[data-state=collapsed]_&]:after:hidden",
...
const SidebarMenuSkeleton = React.forwardRef(({ className, showIcon = false, ...props }, ref) => {
    ...
    return (
        <div
            ...
            {...props}
        >
            {showIcon && <div className="size-4 rounded-md bg-sidebar-accent/50" />}
            <div
...
const SidebarMenuSubButton = React.forwardRef(({ asChild = false, isActive, size = "md", className, ...props }, ref) => {
