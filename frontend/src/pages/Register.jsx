...
export default function Register() {
    ...
    return (
        <div className="relative flex items-center justify-center min-h-screen gradient-mesh overflow-hidden">
            {/* Floating Orbs */}
            <div className="absolute top-[15%] right-[10%] w-72 h-72 rounded-full bg-emerald-400/10 blur-3xl pointer-events-none" style={{ animation: 'float 9s ease-in-out infinite' }} />
            <div className="absolute bottom-[15%] left-[10%] w-96 h-96 rounded-full bg-teal-400/8 blur-3xl pointer-events-none" style={{ animation: 'float 11s ease-in-out infinite 1.5s' }} />
            <div className="absolute top-[50%] right-[50%] w-48 h-48 rounded-full bg-amber-300/6 blur-3xl pointer-events-none" style={{ animation: 'float 7s ease-in-out infinite 3s' }} />
            ...
            >
                <Card className="w-[460px] border-white/20 shadow-2xl shadow-teal-900/10 rounded-2xl overflow-hidden bg-white/70 backdrop-blur-2xl">
